    ...
    return (
        <div className={`px-15 overflow-y-scroll scrollbar-hide ${laptop ? 'max-h-60' : 'max-h-70'}`}>
            ...
            <div key={item.id} className='flex items-center border-l-[0.5px] border-[#a70] py-5'>
                <motion.div
                    className='mainClor bg-[#EEE8DC] dark:bg-[#222] border-[0.7px] rounded-[35%] max-w-[30px] min-w-[30px] max-h-[30px] min-h-[30px] centered -translate-x-[50%]'
                ...
                >
                    <p className='mainClor'>{item.title}</p>
