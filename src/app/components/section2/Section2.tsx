    ...
    return (
        <section className='text-center'>
            <div className='bg-[#252525] py-10 px-18'>
                ...
                <h6 className='text-[#bba593] mt-1 mb-3'>Booking your next appointment has never been easier. Whether you're planning a quick trim, a fresh color, or a full day of pampering, our simple booking system lets you choose the perfect time, service, and stylist — all in just a few taps.</h6>
                <h6 className='border-[0.5px] border-[#bba593] text-[#bba593] py-1 px-3 w-fit mx-auto'>Book now. Shine later</h6>
            </div>
            <div className='bg-[#EEE8DC] py-10'>
