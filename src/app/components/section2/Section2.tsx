    ...
    return (
        <section className='text-center bg-[#EEE8DC]'>
            <div className='bg-[#222] py-10 px-18 border-t-[0.5px] mainBorder'>
                ...
                <h6 className='text-white opacity-70 mt-1 mb-3 lg:px-70 lg:font-[200]'>Booking your next appointment has never been easier. Whether you're planning a quick trim, a fresh color, or a full day of pampering, our simple booking system lets you choose the perfect time, service, and stylist — all in just a few taps.</h6>
